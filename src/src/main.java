...
public class main {
	...
	public static void main(String[] args) {
		...
		long startFirst1024 = System.nanoTime();
		tests1024(myMsg);
		long finishFirst1024 = System.nanoTime();
		long startSecond1024 = System.nanoTime();
		tests1024(myMsg);
		long finishSecond1024 = System.nanoTime();
		long startThird1024 = System.nanoTime();
		tests1024(myMsg);
		long finishThird1024 = System.nanoTime();
		
		long startFirst2048 = System.nanoTime();
		tests2048(myMsg);
		long finishFirst2048 = System.nanoTime();
		long startSecond2048 = System.nanoTime();
		tests2048(myMsg);
		long finishSecond2048 = System.nanoTime();
		long startThird2048 = System.nanoTime();
		tests2048(myMsg);
		long finishThird2048 = System.nanoTime();
		
		long startFirst4096 = System.nanoTime();
		tests4096(myMsg);
		long finishFirst4096 = System.nanoTime();
		long startSecond4096 = System.nanoTime();
		tests4096(myMsg);
		long finishSecond4096 = System.nanoTime();
		long startThird4096 = System.nanoTime();
		tests4096(myMsg);
		long finishThird4096 = System.nanoTime();
		
		long startFirst8192 = System.nanoTime();
		tests8192(myMsg);
		long finishFirst8192 = System.nanoTime();
		long startSecond8192 = System.nanoTime();
		tests8192(myMsg);
		long finishSecond8192 = System.nanoTime();
		long startThird8192 = System.nanoTime();
		tests8192(myMsg);
		long finishThird8192 = System.nanoTime();
		
		System.out.println("1024 first timing: " + ((finishFirst1024 - startFirst1024)/1000000) + "ms");
		System.out.println("1024 second timing: " + ((finishSecond1024 - startSecond1024)/1000000) + "ms");
		System.out.println("1024 third timing: " + ((finishThird1024 - startThird1024)/1000000) + "ms");
		
		System.out.println("2048 first timing: " + ((finishFirst2048 - startFirst2048)/1000000) + "ms");
		System.out.println("2048 second timing: " + ((finishSecond2048 - startSecond2048)/1000000) + "ms");
		System.out.println("2048 third iming: " + ((finishThird2048 - startThird2048)/1000000) + "ms");
		
		System.out.println("4096 first timing: " + ((finishFirst4096 - startFirst4096)/1000000) + "ms");
		System.out.println("4096 second timing: " + ((finishSecond4096 - startSecond4096)/1000000) + "ms");
		System.out.println("4096 third timing: " + ((finishThird4096 - startThird4096)/1000000) + "ms");
		
		System.out.println("8192 first timing: " + ((finishFirst8192 - startFirst8192)/1000000) + "ms");
		System.out.println("8192 second timing: " + ((finishSecond8192 - startSecond8192)/1000000) + "ms");
		System.out.println("8192 third timing: " + ((finishThird8192 - startThird8192)/1000000) + "ms");
